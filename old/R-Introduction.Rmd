---
title: "Starting with R and RStudio - A brief introduction for civil engineering courses"
...
[here](https://github.com/EdM44/classes/tree/master/R_exercises/01.Intro_tutorial). They can be downloaded and copied into your working directory (defined below). In what follows, they are assumed to reside in a folder named **files** in your working directory.

The first six pages of this introduction draw heavily from two excellent sources: Lovelace and Cheshire (2014) and Cleveland (2018).
...
used in subsequent commands. What follows is a short run-through of an exercise
...
Before continuing, watch a Youtube video describing R and RStudio, like [this one](https://youtu.be/lVKMsaWju8w). After watching that, you’ll be familiar with the interface and basic functions. Other online references (noted in the video) that are helpful are [Quick-R](https://www.statmethods.net/),
[R-bloggers](https://www.r-bloggers.com/), and
[stackoverflow](https://stackoverflow.com). Google searches for R techniques
often land at one of these. There is also an excellent [introduction to R written by Bill Sundstrom and Michael Kevane of the SCU Economics Department](https://rpubs.com/wsundstrom/home).
